...
- [`get_all_user_data()`](db_get.md) [`get_user_data()`](db_get.md)
  ...
  [`get_registry_full_name()`](db_get.md)
  [`get_nordic_state()`](db_get.md) [`get_nordic_ind_text()`](db_get.md)
  [`get_org_name()`](db_get.md) [`get_hospitals()`](db_get.md)
  [`get_hfs()`](db_get.md) [`get_rhfs()`](db_get.md)
  [`get_flat_org()`](db_get.md) [`get_all_orgnr()`](db_get.md)
  [`get_user()`](db_get.md) [`get_users()`](db_get.md)
  [`get_registry_indicators()`](db_get.md)
  ...
  [`get_registry_notices()`](db_get.md) [`get_all_notices()`](db_get.md)
  [`get_notice_events()`](db_get.md) : Retreiv data from imongr database
...
- [`notice_ui()`](mod_notice.md) [`notice_server()`](mod_notice.md) :
