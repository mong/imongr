...
## What's Changed
* chore: Fiks for å kjøre docker compose på arm by @arnfinn in https://github.com/mong/imongr/pull/626
* fix: sorter eksplisitt på år før dekningsgrad legges på agg-data by @Stein-Kato in https://github.com/mong/imongr/pull/632


**Full Changelog**: https://github.com/mong/imongr/compare/v2.11.0...v2.11.1

# imongr 2.11.0

## What's Changed
* Kombiner alle action updates i en PR by @arnfinn in https://github.com/mong/imongr/pull/623
* Update github actions (major) by @renovate[bot] in https://github.com/mong/imongr/pull/624
* chore: slå av error på større nevner enn teller by @Stein-Kato in https://github.com/mong/imongr/pull/625


**Full Changelog**: https://github.com/mong/imongr/compare/v2.10.0...v2.11.0

# imongr 2.10.0

## What's Changed
* Fiks varsel by @Stein-Kato in https://github.com/mong/imongr/pull/600
* Update actions/upload-artifact action to v5 by @renovate[bot] in https://github.com/mong/imongr/pull/598
* Tillat opptaksområder i kvalitetsforbedringsprosjekter by @Stein-Kato in https://github.com/mong/imongr/pull/605
* Update actions/upload-artifact action to v6 by @renovate[bot] in https://github.com/mong/imongr/pull/612
* Update actions/checkout action to v6 by @renovate[bot] in https://github.com/mong/imongr/pull/607
* Ny fane for varsler by @Stein-Kato in https://github.com/mong/imongr/pull/614


**Full Changelog**: https://github.com/mong/imongr/compare/v2.9.1...v2.10.0
