...
env_host_verify <- Sys.getenv("IMONGR_DB_HOST_VERIFY")
env_host_qa <- Sys.getenv("IMONGR_DB_HOST_QA")
...
Sys.setenv(IMONGR_DB_HOST_VERIFY = env_host_verify)
Sys.setenv(IMONGR_DB_HOST_QA = env_host_qa)
